...
const features: DashboardFeature[] = [
  ...
  },
  {
    ...
    route: '/map3d',
    ready: false,
    description: 'Turn approved plans into spatial 3D previews.',
    simpleUse: 'Coming after 2D planning improves.',
    signal: 'Coming soon',
    accent: 'from-blue-300 via-indigo-400 to-violet-400',
    glow: 'hover:border-indigo-300/50 hover:shadow-[0_0_36px_rgba(129,140,248,0.16)]',
